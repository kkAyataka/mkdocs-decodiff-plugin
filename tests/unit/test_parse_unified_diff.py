...
def test_parse_unified_diff_1():
    ...
    assert diffs[0].line_diffs[1].anchor_no == 1
    assert diffs[0].line_diffs[1].line_no == 43
    assert diffs[0].line_diffs[1].col_start == 0
    assert diffs[0].line_diffs[1].col_end == 11

    assert diffs[0].line_diffs[2].anchor_no == 2
    assert diffs[0].line_diffs[2].line_no == 72
    assert diffs[0].line_diffs[2].col_start == 0
    assert diffs[0].line_diffs[2].col_end == 133

    assert diffs[0].line_diffs[3].anchor_no == 3
    assert diffs[0].line_diffs[3].line_no == 76
    assert diffs[0].line_diffs[3].col_start == 0
    assert diffs[0].line_diffs[3].col_end == 102

    assert diffs[0].line_diffs[4].anchor_no == 4
    assert diffs[0].line_diffs[4].line_no == 77
    assert diffs[0].line_diffs[4].col_start == 0
    assert diffs[0].line_diffs[4].col_end == 0
...
def test_parse_unified_diff_2():
    ...
    assert diffs[2].from_file == "tests/_res/subdir/file3-rm.md"
